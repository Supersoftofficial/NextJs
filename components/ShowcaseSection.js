      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <p className="text-white text-md md:text-lg leading-relaxed mt-2">
              Revolutionary healthcare platform connecting patients and
              providers
            </p>
            <div className="flex items-baseline gap-2 pt-2">
              <span className="text-4xl md:text-5xl font-bold text-[#40B2FF]">
                +300%
              </span>
            ...
            <Button className="!rounded-full bg-[#1E88E5] text-white font-medium text-[13.35px] leading-[100%] tracking-[-0.02em] text-center align-middle px-6 sm:px-8 md:px-12 py-3 sm:py-4 md:py-6 mt-6 text-sm sm:text-base md:text-lg hover:opacity-90 transition-opacity">
              View Case Study
            </Button>
        ...
        >
          ...
          <div className="relative z-10 flex flex-col items-center justify-between text-center space-y-6">
            ...
            <p className="text-white text-md md:text-lg leading-relaxed max-w-full mx-auto">
              Revolutionary healthcare platform connecting patients and
              providers
            </p>
            <Button className="!rounded-full bg-[#1E88E5] text-white font-medium text-[13.35px] leading-[100%] tracking-[-0.02em] text-center align-middle px-6 sm:px-8 md:px-12 py-3 sm:py-4 md:py-6 text-sm sm:text-base md:text-lg hover:opacity-90 transition-opacity">
              View Case Study
            </Button>
        ...
        >
          ...
          <div className="relative z-10 flex flex-col items-center text-center space-y-6">
            ...
            <Button
              className="!rounded-full bg-[#1E88E5] text-white  px-6 sm:px-8 md:px-12 py-3 sm:py-4 md:py-6 text-sm sm:text-base md:text-lg hover:opacity-90 transition-opacity  
            ...
            font-medium text-[13.35px] leading-[100%] tracking-[-0.02em] text-center align-middle
        ...
        <div className="relative bg-[#131313] rounded-2xl p-4 md:p-6 group transition-all duration-300 hover:border-primary/30 lg:col-span-2">
          <div className="flex flex-col lg:flex-row gap-6 items-center">
            <div className="flex-1 text-center lg:text-left order-2 lg:order-1">
              ...
              <p className="text-white text-md md:text-lg leading-relaxed max-w-full mb-6">
                Revolutionary healthcare platform connecting patients and
                providers
              </p>
