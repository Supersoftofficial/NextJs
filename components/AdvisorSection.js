            ...
            <div className="flex flex-col sm:flex-row gap-4 md:gap-6">
              ...
              <div className="flex-1 space-y-4 md:space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-3">
                  <Button
                    variant="secondary"
                    className="rounded-full px-3 py-1.5 sm:px-4 sm:py-2 text-xs sm:text-sm bg-secondary/80 hover:bg-secondary border border-border/50 justify-center sm:justify-start"
                  >
                    → Mobile App
                  </Button>
                  <Button
