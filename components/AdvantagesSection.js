...
//               <div className="bg-background p-4 sm:p-6 border-b-2 border-b-gray-700 border-border b">
...
//                     </h3>
//                   </div>
//                   <div className="p-4 sm:p-6 border-b-2 border-b-gray-700 flex items-center gap-2 sm:gap-3 bg-[#0088FF]">
...
//                   <div className="bg-background p-4 sm:p-6 border-b-2 border-b-gray-700 border-border flex items-center gap-2 sm:gap-3">
