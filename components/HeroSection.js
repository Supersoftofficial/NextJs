      ...
      <div className='container mx-auto px-4 sm:px-6 lg:px-8'>
        <div className='grid lg:grid-cols-2 gap-8 lg:gap-12 items-center'>
          ...
          <div className='space-y-6 lg:space-y-8 order-2 lg:order-1 relative z-20'>
            ...
            {/* Title */}
            <div className='text-center lg:text-left'>
              <h1 className='font-jakarta font-bold text-3xl sm:text-5xl md:text-6xl lg:text-[65px] leading-tight sm:leading-snug `md:leading-[96px]` text-white'>
                {slides[activeSlide].title}
                <br />
                That Turn Ideas
                <br />
