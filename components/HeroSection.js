...
const HeroSection = () => {
  return (
    <section className=" mt-6 min-h-screen gradient-bg  pb-20 px-4 md:px-6 relative overflow-hidden">
          ...
          <div className="space-y-6 lg:space-y-8 order-2 lg:order-1 relative z-20">
            ...
            <div className="text-center lg:text-left">
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold leading-tight">
                ...
                That Turn Ideas
                <br />
                Into <span className="text-[#0088FF]">Revenue</span>
              </h1>
            </div>

            {/* Description */}
            <p className="text-muted-foreground text-base sm:text-lg md:text-xl max-w-2xl leading-relaxed text-center lg:text-left mx-auto lg:mx-0">
            ...
            <div className="flex flex-col sm:flex-row flex-wrap justify-center lg:justify-start gap-6 sm:gap-8 pt-4">
              ...
              <div className="flex flex-col items-center sm:items-start space-y-3 min-w-[120px]">
                ...
                <div className="space-y-1 text-center sm:text-left">
                  ...
                  <div className="text-sm sm:text-base text-[#1E88E5] font-medium">Apps Built</div>
                </div>
              </div>
              ...
              <div className="flex flex-col items-center sm:items-start space-y-3 min-w-[120px] mt-4">
                ...
                <div className="space-y-1 text-center sm:text-left">
                  ...
                  <div className="text-sm sm:text-base text-[#1E88E5] font-medium">Success Rate</div>
                </div>
              </div>
              ...
              <div className="flex flex-col items-center sm:items-start space-y-3 min-w-[120px]">
                ...
                <div className="space-y-1 text-center sm:text-left">
                  <div className="text-xl sm:text-2xl font-bold text-foreground">Support</div>
            ...
            <div className="pt-4 flex justify-center lg:justify-start">
              <Button className="!rounded-full gradient-blue bg-[#1E88E5] text-white font-semibold px-8 py-6 sm:px-12 sm:py-7 md:px-16 md:py-7 text-base sm:text-lg hover:opacity-90 transition-opacity w-full sm:w-auto">
