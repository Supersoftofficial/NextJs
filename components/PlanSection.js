...
//           <h2
//             className="text-[54.6px] font-bold text-transparent  mt-2 bg-clip-text bg-gradient-to-r from-white to-gray-400 leading-tight
...
const PlanSection = () => {
  ...
  const pricingPlans = [
    {
      ...
      hoverBgClass:
        'bg-[linear-gradient(180deg,rgba(0,136,255,1)_0%,rgba(4,38,68,1)_100%)]',
      defaultButtonClass: 'bg-[#008efe]',
      hoverButtonClass: 'bg-[#050505]',
      defaultIconBgClass: 'bg-[#868686]',
      hoverIconBgClass: 'bg-[#ffffff69]',
      features: [
        { text: 'Native iOS & Android app', icon: '/tick.png' },
        { text: 'Basic backend infrastructure', icon: '/tick.png' },
        { text: 'User authentication & profiles', icon: '/tick.png' },
        { text: '1 month post-launch support', icon: '/tick.png' },
        { text: 'App store submission assistance', icon: '/tick.png' },
      ],
      decorativeElements: {
        ellipse1: { top: 'top-[27px]', left: 'left-[250px]' },
        ellipse2: { top: 'top-[27px]', left: 'left-[290px]' },
  ...
  return (
    <div>
      ...
      <section className='relative w-full'>
        <div className='max-w-7xl mx-auto flex flex-col items-center gap-4 text-center'>
          <h2 className='text-[54.6px] font-bold text-transparent mt-2 bg-clip-text bg-gradient-to-r from-white to-gray-400 leading-tight tracking-[-0.02em] text-center'>
            <span className='text-white'>
              Flexible Plans for Every Stage of
            </span>
            <span className='text-[#1e88e5]'> Growth</span>
          </h2>
          <p className='text-2xl text-white max-w-4xl mb-16'>
            From startup MVP to enterprise solution, we have the perfect package
            to bring your vision to life.
          </p>
        </div>
          ...
          <div className='grid grid-cols-1 lg:grid-cols-3 gap-8 items-start'>
            {pricingPlans.map((plan, index) => {
              ...
              return (
                ...
                >
                  <Card
                    className={`relative rounded-[25px] border-0 overflow-visible transition-all duration-300 ${
                      isGrowth
                        ? plan.defaultBgClass
                        : isHovered
                        ? plan.hoverBgClass
                  ...
                  >
                    <CardContent className='p-0'>
                      <div className='relative pt-20 pb-8'>
                        ...
                        <div
                          className={`absolute ${
                            plan.decorativeElements.iconBox.top
                          } ${
                            plan.decorativeElements.iconBox.left
                          } w-[76px] h-[76px] rounded-[17px] flex items-center justify-center transition-all duration-300 ${
                            isGrowth
                              ? plan.defaultIconBgClass
                              : isHovered
                              ? plan.hoverIconBgClass
                              : plan.defaultIconBgClass
                          }`}
                        >
                          <Image
                        ...
                        {/* Plan Name */}
                        <h3 className='mt-6 text-left text-white text-[62px] font-semibold whitespace-nowrap'>
                          {plan.name}
                        </h3>
                        ...
                        <div className='flex justify-center mt-4'>
                          <Button
                            className={`w-[284px] h-[49px] rounded-xl transition-all duration-300 ${
                              isGrowth
                                ? plan.defaultButtonClass
                                : isHovered
                                ? plan.hoverButtonClass
                                : plan.defaultButtonClass
                            }`}
                          >
                            <span className='text-white font-medium text-xl'>
