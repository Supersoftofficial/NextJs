        ...
        <div className="container mx-auto px-4">
          ...
          <div className="relative w-full">
            ...
            {/* <div className="
              ...
              lg:w-[612px] lg:h-[295px]
              bg-[#176ab2a3] rounded-full
              blur-[40px] sm:blur-[60px] md:blur-[80px] lg:blur-[100px] xl:blur-[129.04px]
              z-0
            " /> */}
            <div
              className="
              ...
              <div className="relative h-full w-full">
                {[
                  ...
                  return (
                    ...
                    >
                      <Card className="bg-[#131313] backdrop-blur-sm border border-gray-700/50 rounded-2xl">
